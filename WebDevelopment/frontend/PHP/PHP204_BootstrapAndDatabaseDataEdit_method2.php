                ...
                <div class="well">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" label="Name" name="Name" value = "<?php echo $name?>" class="form-control" required>
                        </div>
                        <div class="form-group">
            ...
            while( $rows = mysqli_fetch_assoc($run)){
                echo "
                            ...
                            <tr>
                                ...
                                <td>$rows[Mobile]</td>
                                <td>$rows[DOB]</td>
                                <td><a href='PHP204_BootstrapAndDatabaseDataEdit_method2.php?edit_id=$rows[ID]' class='btn btn-success'>Edit</a></td>
                                <td><a href='PHP204_BootstrapAndDatabaseDataEdit_method2.php?del_id=$rows[ID]' class='btn btn-danger'>Delete</a></td>
...
<?php
    if(isset($_POST['Signup'])){
        ...
        if(mysqli_query($conn,$ins_sql)){
            ?>
            <script>window.location='PHP204_BootstrapAndDatabaseDataEdit_method2.php'</script>
<?php
        };

<?php
	...
	if(isset($_REQUEST['edit_form'])){
		...
		$edit_sql = "UPDATE users SET u_name = '$edit_username', u_email = '$edit_email', u_mobile = '$edit_contactnumber', u_notes = '$edit_notes' WHERE u_id = '$_REQUEST[edit_id]'";
								...
								<div class='modal-body'>
									<form onsubmit='return edit_form($rows[u_id]);' id='edit_form$rows[u_id]'>
										...
										<div class='form-group'>
											...
											<input type='text' value='$rows[u_mobile]' id='edit_contactnumber$rows[u_id]' class='form-control' required>
										</div>
										<div class='form-group'>
											<label>Notes</label>
